...
const termsContentEn = `DISCLAIMER AND TERMS OF USE

Welcome to RH Client (H Edition), referred to below as "the Tool." Please read and understand this notice before using the Tool. By using the Tool, you accept and agree to all terms below.

1. Free Software and Intended Use

The Tool is free and open-source/shared software intended for personal learning, research, and non-commercial use.

The developer does not charge users for the Tool. Any fees charged by third-party API services remain the user's responsibility.

2. Lawful Use

Users must comply with all laws and regulations applicable in their jurisdiction when using the Tool.

The Tool must not be used to create or distribute unlawful content, including content that threatens public or national security; pornographic, violent, gambling, criminal, or terrorist content; content that infringes reputation, likeness, intellectual property, or other lawful rights; or deceptive content such as fraud and malicious deepfakes.

3. Disclaimer

Technology neutrality: The Tool is only a technical client that connects to third-party AI services. Content is generated by underlying AI models from prompts and inputs supplied by the user.

User responsibility: The developer cannot control or pre-screen user prompts or generated results. Users are solely responsible for how they use the Tool and for any resulting legal consequences.

Third-party services: AI and API services are provided by third parties. The developer does not guarantee their availability, accuracy, or copyright status.

4. Rights Reserved

If the Tool is used for unlawful activity, the developer may stop providing services, cooperate with lawful investigations, and reserve the right to pursue available legal remedies.`;
                ...
                <div className="flex-1 overflow-y-auto p-6 scrollbar-thin scrollbar-thumb-slate-300 dark:scrollbar-thumb-slate-600">
                    <div className="prose prose-sm dark:prose-invert max-w-none">
                        <div className="whitespace-pre-wrap font-sans text-slate-700 dark:text-slate-300 leading-relaxed text-base">
                            {language === 'en' ? termsContentEn : termsContent}
                        </div>
                    </div>
                </div>
